...
package com.quanyu.${system}.controller;
...
import com.quanyu.base.api.model.ResultMessage;
import com.quanyu.base.api.query.QueryFilter;
import com.quanyu.base.core.util.string.StringUtil;
import com.quanyu.base.core.web.GenericController;
import com.quanyu.base.core.web.RequestUtil;
import com.quanyu.base.db.id.UniqueIdUtil;
import com.quanyu.base.db.mybatis.domain.PageJson;
import com.quanyu.base.db.mybatis.domain.PageList;
import com.quanyu.${system}.persistence.manager.${class}Manager;
...
public class ${class}Controller extends GenericController{
	...
	public @ResponseBody ${class} getJson(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		${class} ${classVar}=${classVar}Manager.get(id);
		return ${classVar};
	}
	 ...
	 */
	@RequestMapping("save")
	public void save(HttpServletRequest request,HttpServletResponse response,@RequestBody ${class} ${classVar}) throws Exception{
