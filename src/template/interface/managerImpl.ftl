...
package com.quanyu.${system}.${package}.manager.impl;
...
import com.quanyu.${system}.${package}.dao.${subtable.variables.class}Dao;
import com.quanyu.${system}.${package}.model.${subtable.variables.class};
</#list>
</#if>
import com.quanyu.base.db.api.Dao;
import com.quanyu.base.manager.impl.AbstractManagerImpl;
import com.quanyu.${system}.${package}.dao.${class}Dao;
import com.quanyu.${system}.${package}.model.Default${class};
